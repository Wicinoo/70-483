...
namespace Lessons._01
{
    ...
    public class TaskB
    {
        ...
        public static void Run()
        {
            ...
            Console.WriteLine($"operation1(\"value\") = {operation1("value1")}");
            Console.WriteLine($"operation2(\"value\") = {operation2("value2")}");
            Console.WriteLine($"operation3(\"value\") = {operation3("value3")}");
            Console.WriteLine($"operation4(\"value\") = {operation4("value4")}");
            Console.WriteLine($"operation5(\"value\") = {operation5("value5")}");
        }
    }
}