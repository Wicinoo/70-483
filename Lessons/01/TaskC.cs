...
namespace Lessons._01
{
    ...
    public class TaskC
    {
        ...
        {
            Console.WriteLine($"Tyres on {car.GetType().Name} have been changed.");
        }

        static void CleanInterior(Bus bus)
        {
            Console.WriteLine($"Interior of {bus.GetType().Name} have been cleaned.");
