...
namespace Lessons._01
{
    ...
    public class TaskG
    {
        ...
        {
            _currentTemperatureProvider.Stub(x => x.GetTemperature()).Return(18);
            _temperatureSettingsProvider.Stub(x => x.GetRequestedTemperature()).Return(22);
        ...
        public void Check_WhenTemperatureIsAsRequestedAndHeaterIsNotStarted_ShouldNotStartHeater()
        {
            ...
            _temperatureSettingsProvider.Stub(x => x.GetRequestedTemperature()).Return(21);
