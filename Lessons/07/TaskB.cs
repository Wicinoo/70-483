...
namespace Lessons._07
{
    ...
    public class TaskB
    {
        ...
        public static void Run()
        {
            ...
            // Register components
            container.Register(
                Component.For<IUsernamesProvider>().ImplementedBy<UsernamesProvider>().LifeStyle.Singleton,
                Component.For<IDateTimeNowProvider>().ImplementedBy<DateTimeNowProvider>().LifeStyle.Singleton,
                Component.For<IUsernamesRepository>().ImplementedBy<UsernamesRepository>().LifeStyle.Singleton
            );
