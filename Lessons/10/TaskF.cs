...
namespace Lessons._10
{
	...
	public class TaskF {
		public static void Run() {
			Exam exam = new Exam() { Code = "8245", Description = "System test", ScoreToPassInPercentages = 1M, EmailToSupport = "sayhi@fnz.com" };

            List<ValidationResult> results = new List<ValidationResult>();
            ValidationContext context = new ValidationContext(exam, null, null);
