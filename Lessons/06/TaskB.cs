...
namespace Lessons._06
{
    ...
    public class TaskB
    {
        ...
        [Fact]
        public void ToInt32_ForInvalidMoney_ShouldThrowInvalidCasException()
        {
            //throw new NotImplementedException();
        ...
        {
            //throw new NotImplementedException();
            Assert.Equal(1234, Convert.ToInt32(new Money(1234, "USD")));
        }

        [Fact]
        public void ToBoolean_ShouldThrowInvalidCastException()
        {
            //throw new NotImplementedException();
