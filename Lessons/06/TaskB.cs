...
namespace Lessons._06
{
    ...
    public class TaskB
    {
        ...
        {
            var amount = Convert.ToDecimal(new Money(1234.50M, "USD"));   // 1234.50M
        ...
        [Fact]
        public void ToInt32_ForIntMoney_ShouldReturnItsAmount()
        {
            var amount = Convert.ToInt32(new Money(1234, "USD"));
            Assert.Equal(1234, amount);
        }

        [Fact]
        public void ToBoolean_ForAnyMoney_ShouldReturnInvalidCastException()
        {
